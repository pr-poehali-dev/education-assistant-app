      ...
      <div className="flex h-screen">
        <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">EduMate</h1>
        ...
        <div className="flex-1 overflow-auto">
            ...
            <div className="p-8 animate-fade-in">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                {features.map((feature, index) => (
                  <Card 
                    key={index}
                    className="p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer border-0 bg-white"
                  >
              ...
              <Card className="p-6 bg-gradient-to-r from-purple-500 via-blue-500 to-teal-500 border-0 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-xl font-bold mb-2">Начните обучение прямо сейчас</h3>
                    <p className="text-purple-100">Выберите режим и погрузитесь в мир знаний</p>
                  </div>
                  <Button 
          ...
          {activeTab === 'chat' && (
            <div className="h-full flex flex-col animate-fade-in">
              <div className="p-6 border-b border-gray-200 bg-white">
                <h2 className="text-2xl font-bold text-gray-900">AI Чат-помощник</h2>
                <p className="text-gray-600 text-sm">Задавайте вопросы и получайте подробные объяснения</p>
              </div>
          ...
          {activeTab === 'test' && (
            <div className="p-8 animate-fade-in">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Генератор тестов</h2>
                <p className="text-gray-600">Создайте персональный тест по любой теме</p>
              </div>
              ...
              <Card className="p-6 mb-6 bg-white">
                <div className="flex gap-3">
                  <Input
                    ...
                    placeholder="Введите тему для теста (например: Квантовая физика)"
                    className="flex-1"
                  />
                  <Button 
              ...
              {questions.length > 0 && (
                <div className="space-y-6">
                  {questions.map((q, index) => (
                    <Card key={q.id} className="p-6 bg-white animate-scale-in">
          ...
          {activeTab === 'tutor' && (
            <div className="p-8 animate-fade-in">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Режим репетитора</h2>
                <p className="text-gray-600">Интерактивное обучение с проверкой знаний</p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                <Card className="p-6 bg-white text-center">
                  ...
                  <h3 className="font-bold text-gray-900 mb-1">Математика</h3>
                  <p className="text-sm text-gray-600">Алгебра и геометрия</p>
                </Card>
                <Card className="p-6 bg-white text-center">
                  ...
                  <h3 className="font-bold text-gray-900 mb-1">Физика</h3>
                  <p className="text-sm text-gray-600">Механика и термодинамика</p>
                </Card>
                <Card className="p-6 bg-white text-center">
                  ...
                  <h3 className="font-bold text-gray-900 mb-1">Языки</h3>
                  <p className="text-sm text-gray-600">Английский и немецкий</p>
                </Card>
              </div>

              <Card className="p-8 bg-gradient-to-br from-gray-50 to-white">
                <div className="text-center">
                  <Icon name="GraduationCap" size={48} className="mx-auto mb-4 text-purple-500" />
          ...
          {activeTab === 'exam' && (
            <div className="p-8 animate-fade-in">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Подготовка к экзаменам</h2>
                <p className="text-gray-600">Индивидуальные планы и материалы для успешной сдачи</p>
              </div>

              <div className="grid grid-cols-2 gap-6">
                <Card className="p-6 bg-white">
                  <Badge className="mb-4 bg-orange-500">ЕГЭ 2025</Badge>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">План подготовки</h3>
                ...
                <Card className="p-6 bg-white">
                  <Badge className="mb-4 bg-blue-500">Практика</Badge>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Пробные тесты</h3>
                  <p className="text-sm text-gray-600 mb-4">
          ...
          {activeTab === 'language' && (
            <div className="p-8 animate-fade-in">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Практика языков</h2>
                <p className="text-gray-600">Общайтесь с AI для улучшения навыков</p>
              </div>

              <div className="grid grid-cols-3 gap-6">
                {['🇬🇧 English', '🇩🇪 Deutsch', '🇪🇸 Español'].map((lang) => (
                  <Card key={lang} className="p-6 bg-white text-center hover:shadow-xl transition-all cursor-pointer">
                    <div className="text-4xl mb-3">{lang.split(' ')[0]}</div>
                    <h3 className="font-bold text-gray-900">{lang.split(' ')[1]}</h3>
                  </Card>
                ))}
              </div>
            </div>
          ...
          {activeTab === 'profile' && (
            <div className="p-8 animate-fade-in">
              <div className="mb-8">
                ...
                <p className="text-gray-600">Ваша статистика и достижения</p>
              </div>

              <div className="grid grid-cols-3 gap-6 mb-8">
                <Card className="p-6 bg-gradient-to-br from-purple-500 to-purple-600 text-white">
                  <Icon name="Trophy" size={32} className="mb-3" />
                  <div className="text-3xl font-bold mb-1">42</div>
                  <div className="text-sm text-purple-100">Завершено уроков</div>
                </Card>
                <Card className="p-6 bg-gradient-to-br from-blue-500 to-teal-500 text-white">
                  <Icon name="Zap" size={32} className="mb-3" />
                  <div className="text-3xl font-bold mb-1">7</div>
                  <div className="text-sm text-blue-100">Дней подряд</div>
                </Card>
                <Card className="p-6 bg-gradient-to-br from-orange-500 to-amber-500 text-white">
                  <Icon name="Star" size={32} className="mb-3" />
                  <div className="text-3xl font-bold mb-1">98%</div>
                  <div className="text-sm text-orange-100">Средний балл</div>
                </Card>
              </div>

              <Card className="p-6 bg-white">
                <h3 className="text-lg font-bold text-gray-900 mb-4">История обучения</h3>
